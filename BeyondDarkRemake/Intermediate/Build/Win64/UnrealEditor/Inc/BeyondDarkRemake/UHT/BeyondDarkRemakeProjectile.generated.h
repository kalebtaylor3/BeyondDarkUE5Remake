...
struct FHitResult;
#ifdef BEYONDDARKREMAKE_BeyondDarkRemakeProjectile_generated_h
#error "BeyondDarkRemakeProjectile.generated.h already included, missing '#pragma once' in BeyondDarkRemakeProjectile.h"
#endif
...
public: \
	DECLARE_CLASS(ABeyondDarkRemakeProjectile, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/BeyondDarkRemake"), NO_API) \
	DECLARE_SERIALIZER(ABeyondDarkRemakeProjectile) \
...
private: \
	...
	ABeyondDarkRemakeProjectile(const ABeyondDarkRemakeProjectile&); \
public: \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, ABeyondDarkRemakeProjectile); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(ABeyondDarkRemakeProjectile); \
	DEFINE_DEFAULT_CONSTRUCTOR_CALL(ABeyondDarkRemakeProjectile) \
