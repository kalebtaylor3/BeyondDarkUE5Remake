...
#ifdef BEYONDDARKREMAKE_FirstPersonBobComponent_generated_h
#error "FirstPersonBobComponent.generated.h already included, missing '#pragma once' in FirstPersonBobComponent.h"
#endif
...
public: \
	DECLARE_CLASS(UFirstPersonBobComponent, UActorComponent, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/BeyondDarkRemake"), NO_API) \
...
private: \
	...
	UFirstPersonBobComponent(const UFirstPersonBobComponent&); \
public: \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UFirstPersonBobComponent); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UFirstPersonBobComponent); \
	DEFINE_DEFAULT_CONSTRUCTOR_CALL(UFirstPersonBobComponent) \
